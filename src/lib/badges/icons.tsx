...
// Early Bird Special — a sunny-side-up egg, first one on the griddle.
export function FriedEggIcon({ color = "currentColor", className }: IconProps) {
  return (
    <svg {...base} stroke={color} className={className}>
      <path d="M12 4.5C7 5 4 8.5 4.3 12.8c.1 1.6 1.5 2.7 3.2 3.3 1.6.6 3 1.4 4.9 1.4 2.7 0 5.6-1 7.4-3 1.4-1.6 1.7-3.9.6-5.7-.8-1.3-2.2-1.9-2.7-3.2-.7-1.9-3.3-2.4-4.7-1.5-.5.3-.9.4-1 .4Z" />
      <ellipse cx="14" cy="12" rx="2.8" ry="2.3" fill={color} stroke="none" />
    </svg>
  );
}

// Last Call — a reception/service bell, closing up the kitchen for the day.
export function ServiceBellIcon({ color = "currentColor", className }: IconProps) {
  return (
    <svg {...base} stroke={color} className={className}>
      <path d="M5 15c0-4 3-7.5 7-7.5s7 3.5 7 7.5" />
      <path d="M4 15h16" />
      <path d="M11.3 7.2V5.5" />
      <circle cx="12" cy="4.7" r="1" />
    </svg>
  );
}
